...
describe("Test the Google homepage", () => {
  ...
  test('can search Google for "your mom"', async () =>{
    await driver.get("https://www.google.com/")

    await driver.findElement(By.name("q")).sendKeys("your mom", Key.RETURN)

    await driver.wait(until.titleIs("your mom - Google Search"), 1000)
